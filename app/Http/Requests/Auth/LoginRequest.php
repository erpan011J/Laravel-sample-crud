...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'email' => ['required_without:username', 'string', 'exists:users,email'],
    ...
    {
        $this->inputType = filter_var($this->input(key:'input_type'),filter:FILTER_VALIDATE_EMAIL) ? 'email':'username';
